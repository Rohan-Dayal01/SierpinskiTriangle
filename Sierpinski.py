...
def sierpinski(degree, p1, p2, p3, color, line_width, screen):
    ...
    if (degree>0):
        point1 = find_midpoint(p1,p2)
        point2 = find_midpoint(p2,p3)
        point3 = find_midpoint(p1,p3)
        sierpinski(degree-1, p1, point1, point3, color, line_width, screen)#bottom left triangle
        sierpinski(degree-1,point1, p2, point2, color, line_width, screen)#top triangle
        sierpinski(degree-1, point3, point2, p3, color, line_width, screen)#bottom right triangle



    #In the if statement which if true, recursion stops, this is where we will start drawing the triangles
